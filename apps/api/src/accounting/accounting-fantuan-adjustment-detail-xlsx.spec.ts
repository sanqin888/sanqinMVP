...
describe('Fantuan adjustment detail XLSX parser', () => {
  it(
    'uses Order type + Fee type to split compensation and deduction without relying on remarks',
    () => {
  ...
  it('rejects a renamed workbook whose Adjustment Settle Time is outside the filename period', () => {
    expect(() =>
