...
describe('AccountingProviderSettlementQueryService posting states', () => {
  it(
    'returns one posting state per requested document and reuses active Journal evidence',
    async () => {
  ...
  it(
    'returns an empty projection without querying persistence for an empty request',
    async () => {
