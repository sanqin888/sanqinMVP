...
describe('Accounting provider recognition policy', () => {
  it(
    'preserves the current Uber recognition behavior through the default editable rule',
    () => {
...
`,
  ...
  it(
    'supports operator-edited optional ANY matching without changing provider ownership',
    () => {
