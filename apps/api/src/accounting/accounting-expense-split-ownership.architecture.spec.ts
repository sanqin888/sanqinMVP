...
describe('Accounting Expense split ownership foundation', () => {
  ...
  it('keeps existing reads on the legacy source while C0 fails closed on split parity', () => {
    ...
    expect(preview).toContain('document.splits.map');
