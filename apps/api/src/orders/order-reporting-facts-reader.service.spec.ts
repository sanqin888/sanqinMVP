...
describe('OrderReportingFactsReaderService', () => {
  it('preserves the reportable Order status set and current metric query semantics', async () => {
    ...
    const metrics = await service.readMetricsForRange(startDate, endDate);
