...
const ORDER_DETAIL_INVALID_MESSAGE =
  /^\[ubereats order\] detail invalid category=(mapping|business) reason=(MALFORMED_PAYLOAD|MISSING_ORDER_ID|MISSING_TOTAL|EMPTY_ITEMS|MISSING_SCHEDULED_READY_AT|UNRELAYABLE_CUSTOMER_REQUEST)$/;
