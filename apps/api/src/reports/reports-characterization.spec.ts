...
describe('ReportsService KPI and business-day characterization', () => {
  ...
  it(
    'follows process.env.TZ for report-day boundaries before any later StoreConfig normalization',
    async () => {
  ...
  it(
    'uses the configured process timezone and preserves current Order total KPI semantics',
    async () => {
