...
describe('POS to Orders persistence boundary', () => {
  it(
    'keeps POS summary and amendment-history reads off Orders Prisma delegates',
    () => {
  ...
  it(
    'keeps the POS financial projection and amendment persistence adapter owned by Orders',
    () => {
