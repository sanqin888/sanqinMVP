...
export type UberMenuDraftDiffResponse = { storeId: string; lastPublishedAt: string | null; addedItems: string[]; modifiedItems: Array<{ sourceType: string; stableId: string; priceCents: number; isAvailable: boolean }>; deletedItems: string[]; addedGroups: string[]; modifiedGroups: Array<{ stableId: string; minSelect: number; maxSelect: number }>; deletedGroups?: string[]; hierarchyChanges: Array<{ from: string; to: string; type: string }>; deletedEdges?: Array<{ from: string; to: string; type: string }>; priceChanges: Array<{ sourceType: string; stableId: string; priceCents: number }>; availabilityChanges: Array<{ sourceType: string; stableId: string; isAvailable: boolean }> };
