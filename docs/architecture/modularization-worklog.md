...
**PR/SHA:** PR #2252 / source-formatting head `e0112d3f`  
**State:** CI GREEN / FINAL DOCS HEAD PENDING — CI #5381 passed Architecture, API/Web lint/build/strict checks and tests after CI #5380 had stopped at API Lint on Prettier-only formatting in the new architecture assertion  
