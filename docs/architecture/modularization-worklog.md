...
**PR/SHA:** PR #2261 / source head `7b5779e5`  
**State:** REMOTE VALIDATED / FINAL DOC CI PENDING — CI #5417 GREEN; no local lint/build/test/scanner run per repository workflow  
