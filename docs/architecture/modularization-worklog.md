...
**Branch/State:** `phase9-inbox-manual-classification` / SOURCE IMPLEMENTED / LOCAL REVIEW GATE / NO LOCAL TEST EXECUTION PER `AGENTS.md`  
...
**Schema/migration state:** Prisma schema only. No migration file is authored per explicit user instruction; the user will generate/review the migration against the local development database before deployment. No new context edge, scanner allowance, provider wire contract, Journal authority or posting policy.  
