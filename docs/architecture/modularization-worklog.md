...
**PR/SHA/State:** PR #2338 / squash merge `15caabe5`; user follow-up `dev@7b60c9c4` adds the generated migration and lint cleanup; CI #5684 reached API tests but failed on two stale Accounting expectations, so the slice remains **MERGED / CI NOT GREEN** pending the focused test-fix PR.  
