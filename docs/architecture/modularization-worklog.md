...
**Branch/State:** `refactor/phase9-slice8a2-operations-capability-split` from `origin/dev@8bc1f77e` / **PR #2381 / PR CI GREEN / NO MIGRATION**; code head `83d4473d` passed CI #5840 (Architecture, API/Web lint/build/strict/tests).  
