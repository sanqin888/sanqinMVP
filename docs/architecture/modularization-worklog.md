...
**PR/SHA:** local branch `phase9-c2-historical-exceptions`; documentation update only, no remote PR yet  
**State:** PRODUCTION VERIFIED / PASS WITH ONE DOCUMENTED UNRESOLVED EXCEPTION / LOCAL DOC REVIEW GATE  
