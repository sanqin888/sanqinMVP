...
- Phase 5: Slice 0 is **MERGED / CI GREEN** via PR #2193 / `07311f74`, including merged dev CI #5194. Slice 1A is
  **MERGED / PR CI GREEN** via PR #2194 / `db7a1de9`, with CI #5195 passing. Slice 1B is **MERGED / PR CI GREEN**
  ...
  scanner rejects any protected `.menuItem.` delegate. Slice 4C is **LOCAL / REVIEW PENDING** on
  `refactor/phase5-slice4c-customer-runtime-read-boundary`: Orders User/UserAddress persistence reads are zero and
  Customer runtime facts now cross only the stable-ID public capability while Commerce remains **22**.
