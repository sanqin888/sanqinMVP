...
**PR/SHA:** PR #2262 / source head `3320700e`  
**State:** REMOTE VALIDATED / FINAL DOC CI PENDING — CI #5426 GREEN; no local lint/build/test/scanner run per repository workflow  
