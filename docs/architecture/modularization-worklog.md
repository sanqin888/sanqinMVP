...
**PR/SHA:** local branch `docs/phase6-clover-sandbox-sequence` / base `origin/dev@00768897`  
**State:** LOCAL / REVIEW PENDING — docs/governance only; no application behavior changed  
