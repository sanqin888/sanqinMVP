...
**Branch/State:** `fix/accounting-inbox-recognition-prefill-ui` from latest `origin/dev@bd09197d` / **SOURCE COMPLETE / DELIVERY AUTHORIZED / REMOTE CI PENDING / NO MIGRATION**.  
