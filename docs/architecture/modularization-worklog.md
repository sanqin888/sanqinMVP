...
**PR/SHA:** local branch `phase9-5d-c1a-accounting-change-shadow-preview` from `origin/dev@fde52e19`; local review ready  
**State:** SOURCE / LOCAL REVIEW READY — final static diff/status review complete; no CI/deploy/runtime verification claimed  
