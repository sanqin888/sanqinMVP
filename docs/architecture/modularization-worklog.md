...
**Branch/State:** `refactor/phase9-slice8a2-operations-capability-split` from `origin/dev@8bc1f77e` / **SOURCE READY FOR USER REVIEW / NO MIGRATION**.  
