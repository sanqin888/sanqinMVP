...
**PR/SHA:** replacement branch `fix/phase5-durable-cancellation-boundary` after failed PR #2220  
**State:** CI REPAIR / REVIEW PENDING  
...
**PR/SHA:** local branch `feat/phase5-member-subscription-optin-prompt`  
**State:** LOCAL  
