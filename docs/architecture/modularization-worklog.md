...
**Branch/State:** `phase9-structured-expense-csv` from `origin/dev@866966a9` / SOURCE IMPLEMENTED / LOCAL REVIEW GATE / NO LOCAL TEST EXECUTION PER `AGENTS.md`  
...
**Architecture/schema effect:** no Prisma schema/migration, dependency manifest, provider wire contract, context direction, scanner allowance, Journal authority or posting-policy change. The direct-import baseline remains Foundation **2** / External **1** / Identity **2** / Runtime **6**, total **11**, public SCC empty pending GitHub CI after user review.  
