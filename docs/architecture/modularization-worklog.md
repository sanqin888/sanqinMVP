...
**PR/SHA:** PR #2263 / source head `5979fcc0`  
**State:** REMOTE VALIDATED / FINAL DOC CI PENDING — CI #5431 GREEN; no local lint/build/test/scanner run per repository workflow  
